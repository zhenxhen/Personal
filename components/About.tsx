                ...
                <section className="pb-20 border-t border-gray-100 pt-16 -mx-8 px-8">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                        <div>
                            ...
                            <p className="subtitle hover:text-gray-600 transition-colors cursor-pointer inline-block border-b border-black pb-1">
                                jinn.human@gmail.com
                            </p>
                        </div>
                        <div className="mt-8 md:mt-0 flex gap-6 text-gray-400">
                            <span>Instagram</span>
                            <span>LinkedIn</span>
                            <span>CV</span>
                        </div>
